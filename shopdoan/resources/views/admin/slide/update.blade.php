                ...
                <form role="form" action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-sm-8">
                        <div class="form-group {{ $errors->first('sd_link')?'has-error':'' }}" >
                            ...
                            <input type="text" class="form-control" value="{{ $slide->sd_link }}" name="sd_link"  placeholder="Name...">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group " >
                                    ...
                                    <input type="text" value="{{ $slide->sd_sort }}" class="form-control" name="sd_sort"  placeholder="0">
                    ...
                    <div class="col-sm-8">
                            ...
                            <div class="box-body block-images">
                                <div style="margin-bottom: 10px;">
                                    <img src="{{ pare_url_file($slide->sd_image)}}" onerror="this.onerror=null; this.src='http://blogit.trungphu/images/no-image.jpg';" alt="" class="img-thumbnail" style="width: 100%; height: 400px;">
                                </div>
