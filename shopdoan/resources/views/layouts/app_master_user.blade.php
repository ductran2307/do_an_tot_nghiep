    ...
    <body>
        <div class="layout layout-nav-side">
            <div class="navbar navbar-expand-lg bg-dark navbar-dark sticky-top">
                ...
                <img alt="duckduck" src="{{asset('frontend/images/home/Duc_Clock_Vintage_15.png')}}" />
                </a>
            ...
            <div class="main-container">
                ...
                <div class="container">
                    <div class="row justify-content-around col-lg-12 col-xl-12" style="width:100%; padding: 20px;">
                      @yield('content')
                    </div>
                </div>
            </div>
